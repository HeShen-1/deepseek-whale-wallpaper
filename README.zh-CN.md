...
浅色与深色模式均为动态壁纸：鲸鱼持续呼吸、缓慢转身，雾层漂移；指针划过鲸鱼时，周围粒子如液体般绕指针涡旋（纯运动反馈，无光晕、无圆环），离开后约 800ms 柔和归位。下方 GIF 为 2 倍速录制，实际节奏更舒缓。**[打开在线预览 →](https://heshen-1.github.io/deepseek-whale-wallpaper/)**
